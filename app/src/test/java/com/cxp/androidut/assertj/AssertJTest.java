 ...
 * 文 件 名: AssertJTest
 * 创 建 人: CXP
 * 创建日期: 2019-03-12 10:12
 * 描    述: AssertJ测试用例（参考：http://sgq0085.iteye.com/blog/2030609）
 * 修 改 人:
 * 修改时间：
 * 修改备注：
 */
public class AssertJTest {
    ...
    public void testString(){
        ...
        assertThat("chengpeng").isEqualTo("chengpeng").isEqualToIgnoringCase("ChengPeng");
        // 断言开始字符串 结束字符穿 字符串长度
        assertThat("chengpeng").startsWith("c").endsWith("peng").hasSize(9);
        // 断言包含字符串 不包含字符串
        assertThat("chengpeng").contains("en").doesNotContain("cp");
        // 断言字符串只出现过一次
        assertThat("chengpeng").containsOnlyOnce("c");
        // 判断正则匹配
        assertThat("chengpeng").matches("....g...g").doesNotMatch(".*d");
        // as指定错误信息
        assertThat("chengpeng").as("没有a或者b").contains("a").contains("b");
    }
